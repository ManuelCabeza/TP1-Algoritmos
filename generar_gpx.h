...
#define CANT_CARACTERES_INDENTACION 4
 ...
 * FINAL_ENTER </"string">\n
 * 
 * Donde los caracteres '<', '>' y '/' vienen definidos por las macros 
 CARACTER_TAG_INICIO, CARACTER_TAG_FINAL Y CARACTER_TAG_FINALIZAR respectivamente.
 * 
 * La indentación define cuantas veces se imprime el caracter CARACTER_INDENTACION 
 * desde INDENTACION_INICIAL , si no se quiere indentar la salida del
 * gpx basta con poner los 5 macros de INDENTACION_i en 0.
 * 
 * El procedimiento recibe la indentación, un enumerativo tipp_tag y un puntero
