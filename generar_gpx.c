...
void generar_gpx(gga * ggaptr, metadata_t * metptr) {
	...
	printf("%d-%02d-%02dT%02d:%02d:%02.0fZ", metptr->fecha.anio, metptr->fecha.mes, metptr->fecha.dia, metptr->horario.hora, metptr->horario.minuto, metptr->horario.segundos);
